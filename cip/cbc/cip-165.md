...
description: A standard method to publish and detect what interfaces a smart contract implements on Core Blockchain.
keywords: [cip, cip-165, interface, detection, standard, core]
