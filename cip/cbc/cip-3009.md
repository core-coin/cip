...
description: >-
  A standardized smart contract interface for transferring CBC-20 tokens via
  signed authorizations (CIP-712), enabling energyless, atomic, and
  meta-transaction-based transfers with random nonces and replay protection.
keywords:
  - cip
  - cip-3009
  - cbc
